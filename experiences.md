...
#### 2023
I joined the Electrotactile Group, which is working on open-source devices. The first project enhances electrotactile through force-coupling, and the device can be used in mouse, touch screen and VR/AR environments. The second project (accepted by CHI 2024) presents a textile interface that provides high-resolution haptic feedback and touch-tracking capabilities, and hints at its potential applications in everyday textile such as yoga mats and pillow covers.
<br>
